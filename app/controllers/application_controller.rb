class ApplicationController < ActionController::Base
  ...
  def gallery;
    @pictures = [
      ...
      {:name => "postmasters_04", :title => "Television sitting room", :desc => "The only television at the Postmasters resides in this room"},
      {:name => "postmasters_05", :title => "Fire place", :desc => "The fireplace of the Postmasters"},
      {:name => "postmasters_06", :title => "Fire place", :desc => "The fireplace of the Postmasters"},
      {:name => "postmasters_07", :title => "Room 1", :desc => "Room one of the Postmasters"},
      ...
      {:name => "postmasters_11", :title => "Television sitting room", :desc => "The only television at the Postmasters resides in this room"},
